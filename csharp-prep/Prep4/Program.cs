...
class Program
{
    static void Main(string[] args)
    {
        ...
        //  we could use a do-while loop here instead
        int userNumber = -1;
        while (userNumber != 0)
        {
            ...
            // Only adding the number to the list if it is not 0
            if (userNumber != 0)
            {
